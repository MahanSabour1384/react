import './styles.css';
function Login() {
  function image(link,styles,classes){
    <img src={link} style={styles} className={classes}/>
  }
  const element=(
    <>
        ...
        <div className="box">
          ...
          <form >
            <center>
              ...
              <input className="loginbtn" type="submit" value="ورود"></input>
            </center>
          </form>
          <a href="#">
            <center>
                <h3 className="common">فراموشی رمز عبور</h3>
            </center>
          </a>

          <h3 style={{margin:'-3% 18% -20% -43%',float:'right'}}>حساب کاربری ندارید؟</h3>

          <a href="Register" action="register.js">
            <center>
                <h3 style={{margin:'-3% -25% -25% -25%'}} className="common">ثبت نام</h3>
            </center>
          </a>
        </div>
    </>
